 ...
 * </p>
 * <ul>
 *   <li>{@link linit.linit.programa#getD <em>D</em>}</li>
 *   <li>{@link linit.linit.programa#getI <em>I</em>}</li>
 * </ul>
 *
 * @see linit.linit.LinitPackage#getprograma()
 * @model
 * @generated
 */
public interface programa extends EObject
{
   ...
   * @see linit.linit.LinitPackage#getprograma_D()
  ...
  /**
   * Sets the value of the '{@link linit.linit.programa#getD <em>D</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see linit.linit.LinitPackage#getprograma_I()
   * @model containment="true"
   * @generated
   */
  instrucciones getI();
  ...
  /**
   * Sets the value of the '{@link linit.linit.programa#getI <em>I</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
